// typst-show.typ — partial customizado do template orange-book.
// Cópia do partial oficial do Quarto + localização pt-BR dos rótulos de
// capítulo/parte (o orange-book não os deriva de `lang` automaticamente).
// Referenciado em _quarto-book.yml > format.typst.template-partials.
